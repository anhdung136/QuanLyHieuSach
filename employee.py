...
class employeeClass:
    ...
    #===========================================================
        ...
        txt_search = Entry(SearchFrame, font=("time new roman", 15), bg="#F3EEEA").place(x=200, y=10)
        btn_search = Button(SearchFrame, text="Tìm", font=("Arial Rounded MT Bold", 17), bg="#C85108", fg="#F4EEC7").place(x=470, y=8, width=80, height=30)


    #==============title======
        title = Label(self.root, text="thông tin chi tiết của nhân viên", font=("time new roman", 15), bg="#61764B", fg="#FFF9C9").place(x=50, y=100, width=1000)

    #============content=========
    #============= hàng 1 ==========
        lbl_empid = Label(self.root, text="Mã số", font=("time new roman", 15), bg="#F1E4C3", fg="#000000").place(x=50, y=150)
        lbl_gender = Label(self.root, text="Giới tính", font=("time new roman", 15), bg="#F1E4C3", fg="#000000").place(x=350, y=150)
        lbl_contact = Label(self.root, text="Liên hệ", font=("time new roman", 15), bg="#F1E4C3", fg="#000000").place(x=750, y=150)
        txt_empid = Entry(self.root, textvariable= self.var_emp_id, font=("time new roman", 15), bg="#F3EEEA", fg="#000000").place(x=122, y=150, width=209)
    ...
    #======== hàng 2 ===========
        lbl_name = Label(self.root, text="Họ và tên", font=("time new roman", 15), bg="#F1E4C3", fg="#000000").place(x=50, y=190)
...
#======== hàng 3 ===========
        lbl_email = Label(self.root, text="Email", font=("time new roman", 15), bg="#F1E4C3", fg="#000000").place(x=50, y=230)
        ...
        txt_email.place(x=115, y=230, width=216)
