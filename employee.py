...
class employeeClass:
    ...
    #======= thông tin nhân viên ===========
        ...
        self.EmployeeTable=ttk.Treeview(emp_frame,columns=("Mã số","Họ tên","Email","Giới tính","Ngày sinh","Mật khẩu","Phân quyền","Địa chỉ","Lương"),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set)
        scrolly.pack(side=RIGHT,fill=Y)
        scrolly.config(command=self.EmployeeTable.yview)
        
        self.EmployeeTable.heading("Ma_so", text=u"Mã số")
        self.EmployeeTable.heading("Ho_ten", text=u"Họ tên")
        self.EmployeeTable.heading("Email", text=u"Email")
        self.EmployeeTable.heading("Gioi_tinh", text=u"Giới tính")
        self.EmployeeTable.heading("Lien_He", text=u"Liên hệ")
        self.EmployeeTable.heading("Ngay_sinh", text=u"Ngày sinh")
        self.EmployeeTable.heading("Mat_khau", text=u"Mật khẩu")
        self.EmployeeTable.heading("Quyen", text=u"Quyền")
        self.EmployeeTable.heading("Dia_chi", text=u"Địa chỉ")
        self.EmployeeTable.heading("Luong", text=u"Lương")

        self.EmployeeTable.pack(fill=BOTH,expand=1)

        self.EmployeeTable.column("Ma_so", width=5)
        self.EmployeeTable.column("Ho_ten", width=100)
        self.EmployeeTable.column("Email", width=50)
        self.EmployeeTable.column("Gioi_tinh", width=17)
        self.EmployeeTable.column("Lien_he", width=30)
        self.EmployeeTable.column("Ngay_sinh", width=40)
        self.EmployeeTable.column("Mat_khau", width=40)
        self.EmployeeTable.column("Quyen", width=10)
        self.EmployeeTable.column("Dia_chi", width=100)
        self.EmployeeTable.column("Luong", width=20)
